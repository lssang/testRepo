...
class printableObject(object):
	def __init__(self, originFilename):
		...
		self._relativeY = 0
		self._relativeZ = 0
		self._HitCnt = 0 	 #for debug
		self._noHitCnt = 0 #for debug
		#self._debug = 0
	...
	def setDrawOffset(self, newOff):
		self._drawOffset = newOff
	...
	def setRelativeX(self,X):
		self._relativeX = X
	def getRelativeY(self):
		return self._relativeY
	def setRelativeY(self,Y):
		self._relativeY = Y
	def getRelativeZ(self):
		return self._relativeZ
	def setRelativeZ(self,Z):
		self._relativeZ = Z

...
class aboutWindow(wx.Dialog):
	def __init__(self):
		...
		title = wx.StaticText(p, -1, 'W-Engine')
		title.SetFont(wx.Font(18, wx.SWISS, wx.NORMAL, wx.BOLD))
		s.Add(title, flag=wx.ALIGN_CENTRE|wx.EXPAND|wx.BOTTOM, border=5)

		s.Add(wx.StaticText(p, -1, 'W-Engine proto version'))
		s.Add(wx.StaticText(p, -1, 'W-Engine is currently developed and maintained by Whoborn.'))

		s.Add(wx.StaticText(p, -1, 'W-Engine is build with the following components:'), flag=wx.TOP, border=10)
